...
def build_scenario(builder):
    ...
    if episode % 5 == 1:
        stored_ball_position_x = random.uniform(-0.99, 0.99)
    ...
    builder.AddPlayer(ball_position_x + random.uniform(-0.01, 0.01), ball_position_y + random.uniform(-0.01, 0.01), player_role_list[0])

    builder.SetTeam(Team.e_Right)
    builder.AddPlayer(-1.0, 0.0, e_PlayerRole_GK, True)
    builder.AddPlayer(0, 0, player_role_list[1])
